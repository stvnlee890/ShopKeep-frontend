...
const UploadImages = () => {
  ...
  const handleSubmit = (event) => {
    if (!uploadImages) {
      ...
      axios
        .post(`https://shopkeepapp.herokuapp.com/images`, formData, {
  ...
  const handleDelete = (event) => {
    ...
    axios
      .delete(`https://shopkeepapp.herokuapp.com/images/${imageKey}`)
      .then(() => {
        const newImageUrl = imageUrl.filter(
    ...
    <div className="upload-images-container">
      ...
      <form onSubmit={handleSubmit}>
        <div className="upload-images-input-container">
          <label htmlFor="image" className="upload-images-label">
      ...
      <div className="finished-button-container">
        <button id="finished-button" type="submit" onClick={handleClick}>
          Finished{" "}
        </button>
      </div>
    </div>
